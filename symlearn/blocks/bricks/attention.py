...
from ..bricks import (Brick, Initializable, Sequence,
                           Feedforward, Linear, Tanh)
from ..bricks.base import lazy, application
from ..bricks.parallel import Parallel, Distribute
from ..bricks.recurrent import recurrent, BaseRecurrent
from ..utils import dict_union, dict_subset, pack
