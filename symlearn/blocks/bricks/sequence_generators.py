...
from ..bricks import Initializable, Random, Bias, NDimensionalSoftmax
from ..bricks.base import application, Brick, lazy
from ..bricks.parallel import Fork, Merge
from ..bricks.lookup import LookupTable
from ..bricks.recurrent import recurrent
from ..bricks.attention import (
    AbstractAttentionRecurrent, AttentionRecurrent)
from ..roles import add_role, COST
from ..utils import dict_union, dict_subset
