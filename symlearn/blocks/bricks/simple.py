...
from ..bricks.base import application, Brick, lazy
from ..bricks.interfaces import Activation, Feedforward, Initializable
from ..bricks.interfaces import LinearLike, Random  # noqa

from ..bricks.wrappers import WithExtraDims
from ..roles import add_role, WEIGHT, BIAS
from ..utils import shared_floatx_nans
